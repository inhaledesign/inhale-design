...
export function EmailSVG () {
    return <svg role='img' width='32' height='32' viewBox='0 -960 960 960'
...
export function LinkedInSVG () {
    return <svg role='img' width='32' height='32' viewBox='0 0 16 16' className='fill-secondary hover:fill-accent'>
...
export function GithubSVG () {
    return <svg role='img' width='32' height='32' viewBox='0 0 24 24' className='fill-secondary hover:fill-accent'>

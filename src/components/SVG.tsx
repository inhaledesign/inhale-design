...
const linkImageStyle = 'fill-secondary hover:fill-accent'

export function EmailImage () {
    return <svg role={'img'} width={linkImageSize} height={linkImageSize} viewBox={'0 -960 960 960'} className={linkImageStyle}>
...
export function LinkedInImage () {
    return <svg role={'img'} width={linkImageSize} height={linkImageSize} viewBox={'0 0 16 16'} className={linkImageStyle}>
...
export function GithubImage () {
    return <svg role={'img'} width={linkImageSize} height={linkImageSize} viewBox={'0 0 24 24'} className={linkImageStyle}>
